...
{
    public class EventoBitacoraDAC : DataAccessComponent, IRepository2<EventoBitacora>
    {
        ...
        public EventoBitacora ALoad(IDataReader entity)
        {
            throw new NotImplementedException();
        }

        public List<EventoBitacora> ReadByListado(string id)
        {
            throw new NotImplementedException();
        }

        public List<EventoBitacora> ReadByListado(int id)
        {
            throw new NotImplementedException();
        }
    }
